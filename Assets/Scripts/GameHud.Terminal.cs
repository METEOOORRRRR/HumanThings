...
namespace EarthRecovery
{
    public sealed partial class GameHud
    {
        ...
        bool TerminalButton(Rect rect, string label, bool enabled = true, string icon = null, bool selected = false, bool confirm = false)
        {
            ...
            bool clicked = GUI.Button(rect, new GUIContent(icon == null ? label : "", icon == null ? "" : label), style);
            if (icon != null)
            {
        ...
        void CampPanel()
        {
            ...
            try
            {
                ...
                GUI.Label(new Rect(212, 194, 1000, 44), "베이스캠프 단말기", TerminalText(30));
                GUI.Label(new Rect(1230, 205, 230, 30), "HUMAN THINGS", TerminalText(17));
                ...
                GUI.Label(new Rect(212, 270, 450, 36), "주변 지역 지도", TerminalText(22));
                GUI.Label(new Rect(696, 270, 440, 36), "회수 임무", TerminalText(22));
                GUI.Label(new Rect(1170, 270, 338, 36), "협동 연결", TerminalText(22));
                ...
                GUI.Label(new Rect(1194, 708, 290, 40), "생존 요원 " + alive + "명", TerminalText(18));
                if (missions.Length == 0) GUI.Label(new Rect(696, 316, 440, 60), "회수 임무 대기", TerminalText(20));
                else
                {
                ...
                if (!string.IsNullOrEmpty(GUI.tooltip)) GUI.Label(new Rect(1170, 775, 338, 30), GUI.tooltip, TerminalText(16, TextAnchor.MiddleCenter));
            }
