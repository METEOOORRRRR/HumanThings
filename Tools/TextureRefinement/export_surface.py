...
bpy.ops.import_scene.gltf(filepath=str(ROOT/'Assets/Character/Meshy_AI_Toxic_Bunny_R_31_All_Animations.glb'))
...
np.savez_compressed(str(ROOT/'QA/ToxicBunnyTexture/surface.npz'),pos=positions[tri],uv=uv,norm=norm,tangent=tangent,sign=sign)
